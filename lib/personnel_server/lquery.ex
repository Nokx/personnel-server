defmodule PersonnelServer.Lquery do
    ...
    # Use this extension when `type` from %Postgrex.TypeInfo{} is "lquery"
    def matching(_state), do: [type: "lquery"]
  
    # Use the text format, "lquery" does not have a binary format.
    def format(_state), do: :text
  
    # Use quoted expression to encode a string that is the same as
    # postgresql's lquery text format. The quoted expression should contain
